...
public class FracCalc3 {
	...
	public static String produceAnswer(String input) {
		...
		System.out.println(whole2 + " " + numerator2 + " " + denominator2);
		...
		System.out.println(int_whole1 + " " + int_numerator1 + " " + int_denominator1);
		System.out.println(int_whole2 + " " + int_numerator2 + " " + int_denominator2);
