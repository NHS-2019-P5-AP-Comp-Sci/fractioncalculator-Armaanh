...
public class FracCalcFinal {
	...
	public static void main(String[] args) {
		...
		System.out.println("This is a fraction calculator betwen integers and/or fractions.");
	...
	public static String produceAnswer(String input) {
		...
		// parses the integer
		// splits the first operand into whole number, numerator,
		...
		// results in num3 and den3,
		// which are answers in improper format
		...
		// if greatest common denominator is 0 = error
		...
		// for the case if numerator
//denominator are negative and cancel each other
		...
		// depending on whether there is a whole number or not
